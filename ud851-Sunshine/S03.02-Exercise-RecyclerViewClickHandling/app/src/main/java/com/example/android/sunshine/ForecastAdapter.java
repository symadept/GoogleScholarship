...
public class ForecastAdapter extends RecyclerView.Adapter<ForecastAdapter.ForecastAdapterViewHolder> {
    ...
    // COMPLETED (2) Within that interface, define a void method that access a String as a parameter
        public void OnItemClicked(String weatherOfDay);
    ...
    public class ForecastAdapterViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if(mWeatherData != null && mWeatherData.length > 0 && position < mWeatherData.length && position > -1) {
                mClickHandler.OnItemClicked(mWeatherData[position]);
            } else {
                Log.d(TAG, "*** Invalid data on click");
            }
        }
    }
